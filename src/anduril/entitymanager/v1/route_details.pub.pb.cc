...
#if defined(PROTOBUF_CUSTOM_VTABLE)
            ::google::protobuf::Message::GetDeleteImpl<RouteDetails>(),
...
const ::google::protobuf::MessageLite::ClassData* RouteDetails::GetClassData() const {
