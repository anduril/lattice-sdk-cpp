...
class MediaItem final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:anduril.entitymanager.v1.MediaItem) */ {
 public:
  inline MediaItem() : MediaItem(nullptr) {}
  ~MediaItem() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR MediaItem(::google::protobuf::internal::ConstantInitialized);

  inline MediaItem(const MediaItem& from)
      : MediaItem(nullptr, from) {}
  ...
  static ::absl::string_view FullMessageName() {
    return "anduril.entitymanager.v1.MediaItem";
  }
  protected:
...
class Media final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:anduril.entitymanager.v1.Media) */ {
 public:
  ...
  friend class ::google::protobuf::internal::AnyMetadata;
  static ::absl::string_view FullMessageName() {
    return "anduril.entitymanager.v1.Media";
  }
  protected:
  ...
  ::google::protobuf::RepeatedPtrField< ::anduril::entitymanager::v1::MediaItem >*
      mutable_media();
  private:
  ...
  const ::google::protobuf::RepeatedPtrField< ::anduril::entitymanager::v1::MediaItem >&
      media() const;
