...
static ::_pb::Metadata file_level_metadata_anduril_2fentitymanager_2fv1_2fschedule_2epub_2eproto[3];
...
const ::uint32_t TableStruct_anduril_2fentitymanager_2fv1_2fschedule_2epub_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    protodesc_cold) = {
    ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_anduril_2fentitymanager_2fv1_2fschedule_2epub_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
...
const ::_pbi::DescriptorTable descriptor_table_anduril_2fentitymanager_2fv1_2fschedule_2epub_2eproto = {
    false,
    false,
    813,
    ...
    file_level_metadata_anduril_2fentitymanager_2fv1_2fschedule_2epub_2eproto,
...
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_anduril_2fentitymanager_2fv1_2fschedule_2epub_2eproto_getter() {
  return &descriptor_table_anduril_2fentitymanager_2fv1_2fschedule_2epub_2eproto;
}
// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2
static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_anduril_2fentitymanager_2fv1_2fschedule_2epub_2eproto(&descriptor_table_anduril_2fentitymanager_2fv1_2fschedule_2epub_2eproto);
namespace anduril {
namespace entitymanager {
namespace v1 {
...
const char* Schedules::_InternalParse(
...
const ::google::protobuf::Message::ClassData Schedules::_class_data_ = {
    Schedules::MergeImpl,
    nullptr,  // OnDemandRegisterArenaDtor
};
const ::google::protobuf::Message::ClassData* Schedules::GetClassData() const {
  return &_class_data_;
}

void Schedules::MergeImpl(::google::protobuf::Message& to_msg, const ::google::protobuf::Message& from_msg) {
...
PROTOBUF_NOINLINE bool Schedules::IsInitialized() const {
  return true;
}

::_pbi::CachedSize* Schedules::AccessCachedSize() const {
...
::google::protobuf::Metadata Schedules::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_anduril_2fentitymanager_2fv1_2fschedule_2epub_2eproto_getter, &descriptor_table_anduril_2fentitymanager_2fv1_2fschedule_2epub_2eproto_once,
      file_level_metadata_anduril_2fentitymanager_2fv1_2fschedule_2epub_2eproto[0]);
}
// ===================================================================
...
const ::google::protobuf::Message::ClassData* Schedule::GetClassData() const {
  return &_class_data_;
}
...
void Schedule::MergeImpl(::google::protobuf::Message& to_msg, const ::google::protobuf::Message& from_msg) {
  ...
  if (from._internal_schedule_type() != 0) {
    _this->_internal_set_schedule_type(from._internal_schedule_type());
  }
  _this->_internal_metadata_.MergeFrom<::google::protobuf::UnknownFieldSet>(from._internal_metadata_);
}
...
::_pbi::CachedSize* Schedule::AccessCachedSize() const {
  return &_impl_._cached_size_;
}
...
::google::protobuf::Metadata Schedule::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_anduril_2fentitymanager_2fv1_2fschedule_2epub_2eproto_getter, &descriptor_table_anduril_2fentitymanager_2fv1_2fschedule_2epub_2eproto_once,
      file_level_metadata_anduril_2fentitymanager_2fv1_2fschedule_2epub_2eproto[1]);
}
// ===================================================================
...
const char* CronWindow::_InternalParse(
    const char* ptr, ::_pbi::ParseContext* ctx) {
  ptr = ::_pbi::TcParser::ParseLoop(this, ptr, ctx, &_table_.header);
  return ptr;
}
...
const ::google::protobuf::Message::ClassData CronWindow::_class_data_ = {
    CronWindow::MergeImpl,
    nullptr,  // OnDemandRegisterArenaDtor
};
const ::google::protobuf::Message::ClassData* CronWindow::GetClassData() const {
  return &_class_data_;
}

void CronWindow::MergeImpl(::google::protobuf::Message& to_msg, const ::google::protobuf::Message& from_msg) {
...
PROTOBUF_NOINLINE bool CronWindow::IsInitialized() const {
  return true;
}

::_pbi::CachedSize* CronWindow::AccessCachedSize() const {
  return &_impl_._cached_size_;
}
...
::google::protobuf::Metadata CronWindow::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_anduril_2fentitymanager_2fv1_2fschedule_2epub_2eproto_getter, &descriptor_table_anduril_2fentitymanager_2fv1_2fschedule_2epub_2eproto_once,
      file_level_metadata_anduril_2fentitymanager_2fv1_2fschedule_2epub_2eproto[2]);
}
