...
static ::_pb::Metadata file_level_metadata_anduril_2fentitymanager_2fv1_2fdimensions_2epub_2eproto[1];
...
const ::uint32_t TableStruct_anduril_2fentitymanager_2fv1_2fdimensions_2epub_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    protodesc_cold) = {
    ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_anduril_2fentitymanager_2fv1_2fdimensions_2epub_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
...
const ::_pbi::DescriptorTable descriptor_table_anduril_2fentitymanager_2fv1_2fdimensions_2epub_2eproto = {
    false,
    false,
    384,
    ...
    file_level_metadata_anduril_2fentitymanager_2fv1_2fdimensions_2epub_2eproto,
...
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_anduril_2fentitymanager_2fv1_2fdimensions_2epub_2eproto_getter() {
  return &descriptor_table_anduril_2fentitymanager_2fv1_2fdimensions_2epub_2eproto;
}
// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2
static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_anduril_2fentitymanager_2fv1_2fdimensions_2epub_2eproto(&descriptor_table_anduril_2fentitymanager_2fv1_2fdimensions_2epub_2eproto);
namespace anduril {
namespace entitymanager {
namespace v1 {
// ===================================================================
...
const char* Dimensions::_InternalParse(
...
::uint8_t* Dimensions::_InternalSerialize(
  ...
  if (raw_length_m != 0) {
    ...
    target = ::_pbi::WireFormatLite::WriteFloatToArray(
        1, this->_internal_length_m(), target);
  }
...
const ::google::protobuf::Message::ClassData Dimensions::_class_data_ = {
    Dimensions::MergeImpl,
    nullptr,  // OnDemandRegisterArenaDtor
};
const ::google::protobuf::Message::ClassData* Dimensions::GetClassData() const {
  return &_class_data_;
}

void Dimensions::MergeImpl(::google::protobuf::Message& to_msg, const ::google::protobuf::Message& from_msg) {
...
PROTOBUF_NOINLINE bool Dimensions::IsInitialized() const {
  return true;
}

::_pbi::CachedSize* Dimensions::AccessCachedSize() const {
...
::google::protobuf::Metadata Dimensions::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_anduril_2fentitymanager_2fv1_2fdimensions_2epub_2eproto_getter, &descriptor_table_anduril_2fentitymanager_2fv1_2fdimensions_2epub_2eproto_once,
      file_level_metadata_anduril_2fentitymanager_2fv1_2fdimensions_2epub_2eproto[0]);
}
