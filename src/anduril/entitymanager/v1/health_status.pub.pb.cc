...
ComponentMessage::GetClassData() const {
...
const ::google::protobuf::MessageLite::ClassData*
ComponentHealth::GetClassData() const {
  PROTOBUF_CONSTINIT static const ::google::protobuf::MessageLite::
      ClassDataFull _data_ = {
          {
              &_table_.header,
...
::uint8_t* ComponentHealth::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000001u) {
    target = ::google::protobuf::internal::WireFormatLite::InternalWriteMessage(
        5, *_impl_.update_time_, _impl_.update_time_->GetCachedSize(), target, stream);
  }
...
::uint8_t* Health::_InternalSerialize(
  ...
  // repeated .anduril.entitymanager.v1.ComponentHealth components = 3 [json_name = "components"];
  for (unsigned i = 0, n = static_cast<unsigned>(
                           this->_internal_components_size());
       i < n; i++) {
  ...
  if (cached_has_bits & 0x00000001u) {
    target = ::google::protobuf::internal::WireFormatLite::InternalWriteMessage(
        4, *_impl_.update_time_, _impl_.update_time_->GetCachedSize(), target, stream);
  }
