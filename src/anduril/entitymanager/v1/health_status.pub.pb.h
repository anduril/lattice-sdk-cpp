...
#ifndef anduril_2fentitymanager_2fv1_2fhealth_5fstatus_2epub_2eproto_2epb_2eh
#define anduril_2fentitymanager_2fv1_2fhealth_5fstatus_2epub_2eproto_2epb_2eh
...
/* @@protoc_insertion_point(class_definition:anduril.entitymanager.v1.ComponentMessage) */ {
 public:
  ...
  void operator delete(ComponentMessage* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
    ::google::protobuf::internal::SizedDelete(msg, sizeof(ComponentMessage));
  }
#endif
  ...
  ComponentMessage* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:anduril.entitymanager.v1.AlertCondition) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(AlertCondition* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
    ::google::protobuf::internal::SizedDelete(msg, sizeof(AlertCondition));
  }
#endif
  ...
  AlertCondition* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:anduril.entitymanager.v1.ComponentHealth) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(ComponentHealth* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
    ::google::protobuf::internal::SizedDelete(msg, sizeof(ComponentHealth));
  }
#endif
  ...
  ComponentHealth* New(::google::protobuf::Arena* arena = nullptr) const {
...
inline void Alert::set_allocated_alert_code(std::string* value) {
  ...
  if (::google::protobuf::internal::DebugHardenForceCopyDefaultString() && _impl_.alert_code_.IsDefault()) {
...
inline void AlertCondition::set_allocated_condition_code(std::string* value) {
  ...
  if (::google::protobuf::internal::DebugHardenForceCopyDefaultString() && _impl_.condition_code_.IsDefault()) {
...
#endif  // anduril_2fentitymanager_2fv1_2fhealth_5fstatus_2epub_2eproto_2epb_2eh
