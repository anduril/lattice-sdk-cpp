...
static ::_pb::Metadata file_level_metadata_anduril_2fentitymanager_2fv1_2fgroup_2epub_2eproto[2];
...
const ::uint32_t TableStruct_anduril_2fentitymanager_2fv1_2fgroup_2epub_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    protodesc_cold) = {
    ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_anduril_2fentitymanager_2fv1_2fgroup_2epub_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
...
const ::_pbi::DescriptorTable descriptor_table_anduril_2fentitymanager_2fv1_2fgroup_2epub_2eproto = {
    false,
    false,
    425,
    ...
    file_level_metadata_anduril_2fentitymanager_2fv1_2fgroup_2epub_2eproto,
...
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_anduril_2fentitymanager_2fv1_2fgroup_2epub_2eproto_getter() {
  return &descriptor_table_anduril_2fentitymanager_2fv1_2fgroup_2epub_2eproto;
}
// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2
static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_anduril_2fentitymanager_2fv1_2fgroup_2epub_2eproto(&descriptor_table_anduril_2fentitymanager_2fv1_2fgroup_2epub_2eproto);
namespace anduril {
namespace entitymanager {
namespace v1 {
// ===================================================================
...
class GroupDetails::_Internal {
 public:
  ...
  static const ::anduril::entitymanager::v1::Team& team(const GroupDetails* msg);
};

const ::anduril::entitymanager::v1::Team& GroupDetails::_Internal::team(const GroupDetails* msg) {
  return *msg->_impl_.group_type_.team_;
}
...
GroupDetails::GroupDetails(
  ...
  switch (group_type_case()) {
    case GROUP_TYPE_NOT_SET:
      break;
      case kTeam:
        _impl_.group_type_.team_ = CreateMaybeMessage<::anduril::entitymanager::v1::Team>(arena, *from._impl_.group_type_.team_);
        break;
  }
...
const char* GroupDetails::_InternalParse(
...
const ::_pbi::TcParseTable<0, 1, 1, 0, 2> GroupDetails::_table_ = {
  {
    ...
    {::_pbi::FieldAuxDefaultMessage{}, &::anduril::entitymanager::v1::_Team_default_instance_},
  }}, {{
  }},
};
...
const ::google::protobuf::Message::ClassData GroupDetails::_class_data_ = {
    GroupDetails::MergeImpl,
    nullptr,  // OnDemandRegisterArenaDtor
};
const ::google::protobuf::Message::ClassData* GroupDetails::GetClassData() const {
  return &_class_data_;
}

void GroupDetails::MergeImpl(::google::protobuf::Message& to_msg, const ::google::protobuf::Message& from_msg) {
  ...
  switch (from.group_type_case()) {
    case kTeam: {
      _this->_internal_mutable_team()->::anduril::entitymanager::v1::Team::MergeFrom(
          from._internal_team());
      break;
    }
    case GROUP_TYPE_NOT_SET: {
...
PROTOBUF_NOINLINE bool GroupDetails::IsInitialized() const {
  return true;
}

::_pbi::CachedSize* GroupDetails::AccessCachedSize() const {
...
::google::protobuf::Metadata GroupDetails::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_anduril_2fentitymanager_2fv1_2fgroup_2epub_2eproto_getter, &descriptor_table_anduril_2fentitymanager_2fv1_2fgroup_2epub_2eproto_once,
      file_level_metadata_anduril_2fentitymanager_2fv1_2fgroup_2epub_2eproto[0]);
}
// ===================================================================
...
::google::protobuf::Metadata Team::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_anduril_2fentitymanager_2fv1_2fgroup_2epub_2eproto_getter, &descriptor_table_anduril_2fentitymanager_2fv1_2fgroup_2epub_2eproto_once,
      file_level_metadata_anduril_2fentitymanager_2fv1_2fgroup_2epub_2eproto[1]);
}
