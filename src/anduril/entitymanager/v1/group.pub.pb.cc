...
const char descriptor_table_protodef_anduril_2fentitymanager_2fv1_2fgroup_2epub_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    ...
    "roupPubProtoP\001ZMghe.anduril.dev/anduril/"
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
            ::google::protobuf::internal::ZeroFieldsBase::GetDeleteImpl<GroupDetails>(),
            ::google::protobuf::internal::ZeroFieldsBase::GetNewImpl<GroupDetails>(),
            ::google::protobuf::internal::ZeroFieldsBase::GetClearImpl<GroupDetails>(), &GroupDetails::ByteSizeLong,
...
const ::google::protobuf::MessageLite::ClassData* GroupDetails::GetClassData() const {
  ::google::protobuf::internal::PrefetchToLocalCache(&_class_data_);
  ::google::protobuf::internal::PrefetchToLocalCache(_class_data_.tc_table);
  return _class_data_.base();
}
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::_pbi::TcParseTable<0, 0, 0, 0, 2> GroupDetails::_table_ = {
  {
    0,  // no _has_bits_
    0, // no _extensions_
