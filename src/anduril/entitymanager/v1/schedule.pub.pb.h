...
/* @@protoc_insertion_point(class_definition:anduril.entitymanager.v1.CronWindow) */ {
 public:
  ...
  CronWindow* New(::google::protobuf::Arena* arena = nullptr) const PROTOBUF_FINAL {
...
/* @@protoc_insertion_point(class_definition:anduril.entitymanager.v1.Schedule) */ {
 public:
  ...
  Schedule* New(::google::protobuf::Arena* arena = nullptr) const PROTOBUF_FINAL {
...
/* @@protoc_insertion_point(class_definition:anduril.entitymanager.v1.Schedules) */ {
 public:
  ...
  Schedules* New(::google::protobuf::Arena* arena = nullptr) const PROTOBUF_FINAL {
