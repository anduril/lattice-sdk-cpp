...
static ::_pb::Metadata file_level_metadata_anduril_2fentitymanager_2fv1_2fontology_2epub_2eproto[2];
...
const ::uint32_t TableStruct_anduril_2fentitymanager_2fv1_2fontology_2epub_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    protodesc_cold) = {
    ~0u,  // no _has_bits_
    ...
    PROTOBUF_FIELD_OFFSET(::anduril::entitymanager::v1::Ontology, _impl_.krn_),
...
const char descriptor_table_protodef_anduril_2fentitymanager_2fv1_2fontology_2epub_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
...
const ::_pbi::DescriptorTable descriptor_table_anduril_2fentitymanager_2fv1_2fontology_2epub_2eproto = {
    false,
    false,
    909,
    ...
    file_level_metadata_anduril_2fentitymanager_2fv1_2fontology_2epub_2eproto,
...
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_anduril_2fentitymanager_2fv1_2fontology_2epub_2eproto_getter() {
  return &descriptor_table_anduril_2fentitymanager_2fv1_2fontology_2epub_2eproto;
}
// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2
static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_anduril_2fentitymanager_2fv1_2fontology_2epub_2eproto(&descriptor_table_anduril_2fentitymanager_2fv1_2fontology_2epub_2eproto);
namespace anduril {
namespace entitymanager {
namespace v1 {
// ===================================================================
...
const char* MilView::_InternalParse(
...
::uint8_t* MilView::_InternalSerialize(
  ...
  // .anduril.ontology.v1.Nationality nationality = 3 [json_name = "nationality", (.anduril.entitymanager.v1.overridable) = true];
  if (this->_internal_nationality() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteEnumToArray(
        3, this->_internal_nationality(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:anduril.entitymanager.v1.MilView)
  ...
  if (this->_internal_nationality() != 0) {
    total_size += 1 +
                  ::_pbi::WireFormatLite::EnumSize(this->_internal_nationality());
  }

  return MaybeComputeUnknownFieldsSize(total_size, &_impl_._cached_size_);
}

const ::google::protobuf::Message::ClassData MilView::_class_data_ = {
    MilView::MergeImpl,
    nullptr,  // OnDemandRegisterArenaDtor
};
const ::google::protobuf::Message::ClassData* MilView::GetClassData() const {
  return &_class_data_;
}

void MilView::MergeImpl(::google::protobuf::Message& to_msg, const ::google::protobuf::Message& from_msg) {
  ...
  if (from._internal_nationality() != 0) {
    _this->_internal_set_nationality(from._internal_nationality());
  }
...
PROTOBUF_NOINLINE bool MilView::IsInitialized() const {
  return true;
}

::_pbi::CachedSize* MilView::AccessCachedSize() const {
...
::google::protobuf::Metadata MilView::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_anduril_2fentitymanager_2fv1_2fontology_2epub_2eproto_getter, &descriptor_table_anduril_2fentitymanager_2fv1_2fontology_2epub_2eproto_once,
      file_level_metadata_anduril_2fentitymanager_2fv1_2fontology_2epub_2eproto[0]);
}
// ===================================================================
...
const char* Ontology::_InternalParse(
    const char* ptr, ::_pbi::ParseContext* ctx) {
  ptr = ::_pbi::TcParser::ParseLoop(this, ptr, ctx, &_table_.header);
  return ptr;
}
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::_pbi::TcParseTable<3, 5, 0, 82, 2> Ontology::_table_ = {
  {
    0,  // no _has_bits_
    0, // no _extensions_
    ...
    {::_pbi::TcParser::FastUS1,
     {42, 63, 0, PROTOBUF_FIELD_OFFSET(Ontology, _impl_.krn_)}},
    {::_pbi::TcParser::MiniParse, {}},
    {::_pbi::TcParser::MiniParse, {}},
  }}, {{
    65535, 65535
    ...
    (0 | ::_fl::kFcSingular | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // string krn = 5 [json_name = "krn"];
    {PROTOBUF_FIELD_OFFSET(Ontology, _impl_.krn_), 0, 0,
    (0 | ::_fl::kFcSingular | ::_fl::kUtf8String | ::_fl::kRepAString)},
  }},
  // no aux_entries
  {{
...
::uint8_t* Ontology::_InternalSerialize(
  ...
  for (int i = 0, n = this->_internal_descriptors_size(); i < n; ++i) {
    const auto& s = this->_internal_descriptors().Get(i);
  ...
  // string platform_type = 3 [json_name = "platformType", (.anduril.entitymanager.v1.overridable) = true];
  if (!this->_internal_platform_type().empty()) {
    const std::string& _s = this->_internal_platform_type();
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
  ...
  // string specific_type = 4 [json_name = "specificType", (.anduril.entitymanager.v1.overridable) = true];
  if (!this->_internal_specific_type().empty()) {
    const std::string& _s = this->_internal_specific_type();
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
  ...
  // string krn = 5 [json_name = "krn"];
  if (!this->_internal_krn().empty()) {
    const std::string& _s = this->_internal_krn();
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "anduril.entitymanager.v1.Ontology.krn");
...
// @@protoc_insertion_point(message_byte_size_start:anduril.entitymanager.v1.Ontology)
  ...
  // repeated string descriptors = 1 [json_name = "descriptors", deprecated = true];
  total_size += 1 * ::google::protobuf::internal::FromIntSize(_internal_descriptors().size());
  for (int i = 0, n = _internal_descriptors().size(); i < n; ++i) {
    total_size += ::google::protobuf::internal::WireFormatLite::StringSize(
        _internal_descriptors().Get(i));
  }
  // string platform_type = 3 [json_name = "platformType", (.anduril.entitymanager.v1.overridable) = true];
  if (!this->_internal_platform_type().empty()) {
  ...
  if (this->_internal_template_() != 0) {
    total_size += 1 +
                  ::_pbi::WireFormatLite::EnumSize(this->_internal_template_());
  }

  return MaybeComputeUnknownFieldsSize(total_size, &_impl_._cached_size_);
}

const ::google::protobuf::Message::ClassData Ontology::_class_data_ = {
    Ontology::MergeImpl,
    nullptr,  // OnDemandRegisterArenaDtor
};
const ::google::protobuf::Message::ClassData* Ontology::GetClassData() const {
  return &_class_data_;
}

void Ontology::MergeImpl(::google::protobuf::Message& to_msg, const ::google::protobuf::Message& from_msg) {
  ...
  if (!from._internal_krn().empty()) {
    _this->_internal_set_krn(from._internal_krn());
  }
...
PROTOBUF_NOINLINE bool Ontology::IsInitialized() const {
  return true;
}

::_pbi::CachedSize* Ontology::AccessCachedSize() const {
  return &_impl_._cached_size_;
}
void Ontology::InternalSwap(Ontology* PROTOBUF_RESTRICT other) {
  ...
  ::_pbi::ArenaStringPtr::InternalSwap(&_impl_.krn_, &other->_impl_.krn_, arena);
...
::google::protobuf::Metadata Ontology::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_anduril_2fentitymanager_2fv1_2fontology_2epub_2eproto_getter, &descriptor_table_anduril_2fentitymanager_2fv1_2fontology_2epub_2eproto_once,
      file_level_metadata_anduril_2fentitymanager_2fv1_2fontology_2epub_2eproto[1]);
}
