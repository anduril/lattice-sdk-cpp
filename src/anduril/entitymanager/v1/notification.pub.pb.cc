...
static ::_pb::Metadata file_level_metadata_anduril_2fentitymanager_2fv1_2fnotification_2epub_2eproto[1];
...
const ::uint32_t TableStruct_anduril_2fentitymanager_2fv1_2fnotification_2epub_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    protodesc_cold) = {
...
const char descriptor_table_protodef_anduril_2fentitymanager_2fv1_2fnotification_2epub_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
...
const ::_pbi::DescriptorTable descriptor_table_anduril_2fentitymanager_2fv1_2fnotification_2epub_2eproto = {
    ...
    file_level_metadata_anduril_2fentitymanager_2fv1_2fnotification_2epub_2eproto,
...
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_anduril_2fentitymanager_2fv1_2fnotification_2epub_2eproto_getter() {
  return &descriptor_table_anduril_2fentitymanager_2fv1_2fnotification_2epub_2eproto;
}
// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2
static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_anduril_2fentitymanager_2fv1_2fnotification_2epub_2eproto(&descriptor_table_anduril_2fentitymanager_2fv1_2fnotification_2epub_2eproto);
namespace anduril {
namespace entitymanager {
namespace v1 {
// ===================================================================
...
class OverrideNotificationPayload::_Internal {
 public:
  using HasBits = decltype(std::declval<OverrideNotificationPayload>()._impl_._has_bits_);
  static constexpr ::int32_t kHasBitsOffset =
    8 * PROTOBUF_FIELD_OFFSET(OverrideNotificationPayload, _impl_._has_bits_);
  static const ::anduril::entitymanager::v1::Entity& entity(const OverrideNotificationPayload* msg);
  static void set_has_entity(HasBits* has_bits) {
    (*has_bits)[0] |= 1u;
  }
  static const ::anduril::entitymanager::v1::Provenance& provenance(const OverrideNotificationPayload* msg);
  static void set_has_provenance(HasBits* has_bits) {
    (*has_bits)[0] |= 2u;
  }
};

const ::anduril::entitymanager::v1::Entity& OverrideNotificationPayload::_Internal::entity(const OverrideNotificationPayload* msg) {
  return *msg->_impl_.entity_;
}
const ::anduril::entitymanager::v1::Provenance& OverrideNotificationPayload::_Internal::provenance(const OverrideNotificationPayload* msg) {
...
const char* OverrideNotificationPayload::_InternalParse(
...
const ::google::protobuf::Message::ClassData OverrideNotificationPayload::_class_data_ = {
    OverrideNotificationPayload::MergeImpl,
    nullptr,  // OnDemandRegisterArenaDtor
};
const ::google::protobuf::Message::ClassData* OverrideNotificationPayload::GetClassData() const {
  return &_class_data_;
}

void OverrideNotificationPayload::MergeImpl(::google::protobuf::Message& to_msg, const ::google::protobuf::Message& from_msg) {
...
PROTOBUF_NOINLINE bool OverrideNotificationPayload::IsInitialized() const {
  return true;
}

::_pbi::CachedSize* OverrideNotificationPayload::AccessCachedSize() const {
...
::google::protobuf::Metadata OverrideNotificationPayload::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_anduril_2fentitymanager_2fv1_2fnotification_2epub_2eproto_getter, &descriptor_table_anduril_2fentitymanager_2fv1_2fnotification_2epub_2eproto_once,
      file_level_metadata_anduril_2fentitymanager_2fv1_2fnotification_2epub_2eproto[0]);
}
