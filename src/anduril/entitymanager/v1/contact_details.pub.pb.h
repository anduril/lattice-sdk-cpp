...
#ifndef anduril_2fentitymanager_2fv1_2fcontact_5fdetails_2epub_2eproto_2epb_2eh
...
/* @@protoc_insertion_point(class_definition:anduril.entitymanager.v1.ContactDetails) */ {
 public:
  ...
  void operator delete(ContactDetails* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
    ::google::protobuf::internal::SizedDelete(msg, sizeof(ContactDetails));
  }
#endif
  ...
  ContactDetails* New(::google::protobuf::Arena* arena = nullptr) const {
...
#endif  // anduril_2fentitymanager_2fv1_2fcontact_5fdetails_2epub_2eproto_2epb_2eh
