...
inline void ObjectType::SharedDtor(MessageLite& self) {
  ObjectType& this_ = static_cast<ObjectType&>(self);
  this_._internal_metadata_.Delete<::google::protobuf::UnknownFieldSet>();
  ABSL_DCHECK(this_.GetArena() == nullptr);
  this_._impl_.~Impl_();
}

inline void* ObjectType::PlacementNew_(const void*, void* mem,
                                        ::google::protobuf::Arena* arena) {
  return ::new (mem) ObjectType(arena);
}
constexpr auto ObjectType::InternalNewImpl_() {
  return ::google::protobuf::internal::MessageCreator::ZeroInit(sizeof(ObjectType),
                                            alignof(ObjectType));
}
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::google::protobuf::internal::ClassDataFull ObjectType::_class_data_ = {
...
const ::google::protobuf::internal::ClassData* ObjectType::GetClassData() const {
