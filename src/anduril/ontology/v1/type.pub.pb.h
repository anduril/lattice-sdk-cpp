...
class ObjectType final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:anduril.ontology.v1.ObjectType) */ {
 public:
  inline ObjectType() : ObjectType(nullptr) {}
  ~ObjectType() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR ObjectType(::google::protobuf::internal::ConstantInitialized);

  inline ObjectType(const ObjectType& from)
      : ObjectType(nullptr, from) {}
  ...
  ObjectType* New(::google::protobuf::Arena* arena = nullptr) const final {
  ...
  static ::absl::string_view FullMessageName() {
    return "anduril.ontology.v1.ObjectType";
  }
  protected:
