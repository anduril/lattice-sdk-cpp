...
#ifndef anduril_2ftasks_2fv2_2fcatalog_2epub_2eproto_2epb_2eh
#define anduril_2ftasks_2fv2_2fcatalog_2epub_2eproto_2epb_2eh
...
/* @@protoc_insertion_point(class_definition:anduril.tasks.v2.TaskDefinition) */ {
 public:
  ...
  void operator delete(TaskDefinition* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
    ::google::protobuf::internal::SizedDelete(msg, sizeof(TaskDefinition));
  }
#endif
  ...
  TaskDefinition* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:anduril.tasks.v2.TaskCatalog) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(TaskCatalog* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
    ::google::protobuf::internal::SizedDelete(msg, sizeof(TaskCatalog));
  }
#endif
  ...
  TaskCatalog* New(::google::protobuf::Arena* arena = nullptr) const {
...
inline void TaskDefinition::set_allocated_task_specification_url(std::string* value) {
  ...
  if (::google::protobuf::internal::DebugHardenForceCopyDefaultString() && _impl_.task_specification_url_.IsDefault()) {
...
#endif  // anduril_2ftasks_2fv2_2fcatalog_2epub_2eproto_2epb_2eh
