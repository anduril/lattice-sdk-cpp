...
::uint8_t* Transit::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000001u) {
    target = ::google::protobuf::internal::WireFormatLite::InternalWriteMessage(
        1, *_impl_.plan_, _impl_.plan_->GetCachedSize(), target, stream);
  }
...
::uint8_t* RoutePlan::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000001u) {
    target = ::google::protobuf::internal::WireFormatLite::InternalWriteMessage(
        1, *_impl_.route_, _impl_.route_->GetCachedSize(), target, stream);
  }
...
::uint8_t* PathSegment::_InternalSerialize(
  ...
  switch (end_point_case()) {
    case kWaypoint: {
      target = ::google::protobuf::internal::WireFormatLite::InternalWriteMessage(
          1, *_impl_.end_point_.waypoint_, _impl_.end_point_.waypoint_->GetCachedSize(), target, stream);
      break;
    }
    case kLoiter: {
      target = ::google::protobuf::internal::WireFormatLite::InternalWriteMessage(
          2, *_impl_.end_point_.loiter_, _impl_.end_point_.loiter_->GetCachedSize(), target, stream);
      break;
    }
    default:
      break;
...
::uint8_t* Waypoint::_InternalSerialize(
  ...
  if (point_case() == kLlaPoint) {
    target = ::google::protobuf::internal::WireFormatLite::InternalWriteMessage(
        1, *_impl_.point_.lla_point_, _impl_.point_.lla_point_->GetCachedSize(), target, stream);
  }
...
const ::google::protobuf::MessageLite::ClassData*
SetLaunchRoute::GetClassData() const {
  PROTOBUF_CONSTINIT static const ::google::protobuf::MessageLite::
      ClassDataFull _data_ = {
          {
              &_table_.header,
