...
class Point final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:anduril.tasks.v2.Point) */ {
 public:
...
class Objective final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:anduril.tasks.v2.Objective) */ {
 public:
  inline Objective() : Objective(nullptr) {}
  ~Objective() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR Objective(::google::protobuf::internal::ConstantInitialized);

  inline Objective(const Objective& from)
      : Objective(nullptr, from) {}
  ...
  friend class ::google::protobuf::internal::AnyMetadata;
  static ::absl::string_view FullMessageName() {
    return "anduril.tasks.v2.Objective";
  }
  protected:
...
inline ::anduril::tasks::v2::Point* Objective::_internal_mutable_point() {
  if (objective_case() != kPoint) {
    clear_objective();
    set_has_point();
    _impl_.objective_.point_ = CreateMaybeMessage<::anduril::tasks::v2::Point>(GetArena());
  }
