...
const ::uint32_t
    TableStruct_anduril_2ftype_2fcolor_2epub_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
...
const char descriptor_table_protodef_anduril_2ftype_2fcolor_2epub_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
...
inline PROTOBUF_NDEBUG_INLINE Color::Impl_::Impl_(
    ...
    const Impl_& from, const ::anduril::type::Color& from_msg)
...
const ::google::protobuf::MessageLite::ClassDataFull
    Color::_class_data_ = {
        ::google::protobuf::Message::ClassData{
            ...
            &Color::MergeImpl,
#if defined(PROTOBUF_CUSTOM_VTABLE)
            ::google::protobuf::Message::GetDeleteImpl<Color>(),
...
const ::google::protobuf::MessageLite::ClassData* Color::GetClassData() const {
...
const ::_pbi::TcParseTable<2, 4, 1, 0, 2> Color::_table_ = {
  {
    ...
    ::_pbi::TcParser::GetTable<::anduril::type::Color>(),  // to_prefetch
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::std::false_type
    _static_init2_ PROTOBUF_UNUSED =
        (::_pbi::AddDescriptors(&descriptor_table_anduril_2ftype_2fcolor_2epub_2eproto),
         ::std::false_type{});
