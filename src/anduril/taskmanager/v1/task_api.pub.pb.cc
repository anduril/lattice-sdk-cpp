...
#if defined(PROTOBUF_CUSTOM_VTABLE)
            ::google::protobuf::Message::GetDeleteImpl<ExecuteRequest>(),
...
const ::google::protobuf::MessageLite::ClassData* ExecuteRequest::GetClassData() const {
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
            ::google::protobuf::Message::GetDeleteImpl<CompleteRequest>(),
...
const ::google::protobuf::MessageLite::ClassData* CompleteRequest::GetClassData() const {
  ::google::protobuf::internal::PrefetchToLocalCache(&_class_data_);
  ::google::protobuf::internal::PrefetchToLocalCache(_class_data_.tc_table);
  return _class_data_.base();
}
