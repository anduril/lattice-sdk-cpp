...
class FieldMatcher final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:anduril.blobs.v1.FieldMatcher) */ {
 public:
  inline FieldMatcher() : FieldMatcher(nullptr) {}
  ~FieldMatcher() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR FieldMatcher(::google::protobuf::internal::ConstantInitialized);

  inline FieldMatcher(const FieldMatcher& from)
      : FieldMatcher(nullptr, from) {}
  ...
  FieldMatcher* New(::google::protobuf::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const FieldMatcher& from) {
    FieldMatcher::MergeImpl(*this, from);
  }
  private:
  ...
  static ::absl::string_view FullMessageName() {
    return "anduril.blobs.v1.FieldMatcher";
  }
  protected:
...
class Statement final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:anduril.blobs.v1.Statement) */ {
 public:
  ...
  friend class ::google::protobuf::internal::AnyMetadata;
  static ::absl::string_view FullMessageName() {
    return "anduril.blobs.v1.Statement";
  }
  protected:
  ...
  ::google::protobuf::RepeatedPtrField< ::anduril::blobs::v1::FieldMatcher >*
      mutable_not_match();
  private:
  ...
  const ::google::protobuf::RepeatedPtrField< ::anduril::blobs::v1::FieldMatcher >&
      not_match() const;
...
inline ::anduril::blobs::v1::FieldMatcher* Statement::_internal_mutable_match() {
  ...
  if (_impl_.match_ == nullptr) {
    auto* p = CreateMaybeMessage<::anduril::blobs::v1::FieldMatcher>(GetArena());
...
inline void Statement::set_allocated_match(::anduril::blobs::v1::FieldMatcher* value) {
  ...
  if (message_arena == nullptr) {
    delete reinterpret_cast<::anduril::blobs::v1::FieldMatcher*>(_impl_.match_);
  }

  if (value != nullptr) {
    ::google::protobuf::Arena* submessage_arena = reinterpret_cast<::anduril::blobs::v1::FieldMatcher*>(value)->GetArena();
