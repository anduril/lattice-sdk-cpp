...
/* @@protoc_insertion_point(class_definition:anduril.blobs.v1.BlobProvenance) */ {
 public:
  ...
  BlobProvenance* New(::google::protobuf::Arena* arena = nullptr) const PROTOBUF_FINAL {
...
/* @@protoc_insertion_point(class_definition:anduril.blobs.v1.BlobMetadata) */ {
 public:
  ...
  BlobMetadata* New(::google::protobuf::Arena* arena = nullptr) const PROTOBUF_FINAL {
