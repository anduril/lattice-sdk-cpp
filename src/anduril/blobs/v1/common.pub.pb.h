...
class BlobProvenance final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:anduril.blobs.v1.BlobProvenance) */ {
 public:
  inline BlobProvenance() : BlobProvenance(nullptr) {}
  ~BlobProvenance() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR BlobProvenance(::google::protobuf::internal::ConstantInitialized);

  inline BlobProvenance(const BlobProvenance& from)
      : BlobProvenance(nullptr, from) {}
  BlobProvenance(BlobProvenance&& from) noexcept
    : BlobProvenance() {
    *this = ::std::move(from);
  }
  ...
  friend void swap(BlobProvenance& a, BlobProvenance& b) {
    a.Swap(&b);
  }
  ...
  BlobProvenance* New(::google::protobuf::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<BlobProvenance>(arena);
  }
  using ::google::protobuf::Message::CopyFrom;
  void CopyFrom(const BlobProvenance& from);
  using ::google::protobuf::Message::MergeFrom;
  void MergeFrom( const BlobProvenance& from) {
    BlobProvenance::MergeImpl(*this, from);
  }
  private:
  ...
  static ::absl::string_view FullMessageName() {
    return "anduril.blobs.v1.BlobProvenance";
  }
  protected:
...
class BlobMetadata final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:anduril.blobs.v1.BlobMetadata) */ {
 public:
  inline BlobMetadata() : BlobMetadata(nullptr) {}
  ~BlobMetadata() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR BlobMetadata(::google::protobuf::internal::ConstantInitialized);

  inline BlobMetadata(const BlobMetadata& from)
      : BlobMetadata(nullptr, from) {}
  ...
  void MergeFrom( const BlobMetadata& from) {
    BlobMetadata::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::google::protobuf::Message& to_msg, const ::google::protobuf::Message& from_msg);
  public:
  ...
  friend class ::google::protobuf::internal::AnyMetadata;
  static ::absl::string_view FullMessageName() {
    return "anduril.blobs.v1.BlobMetadata";
  }
  protected:
...
inline void BlobMetadata::set_allocated_provenance(::anduril::blobs::v1::BlobProvenance* value) {
  ...
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  if (message_arena == nullptr) {
    delete reinterpret_cast<::anduril::blobs::v1::BlobProvenance*>(_impl_.provenance_);
  }

  if (value != nullptr) {
    ::google::protobuf::Arena* submessage_arena = reinterpret_cast<::anduril::blobs::v1::BlobProvenance*>(value)->GetArena();
    if (message_arena != submessage_arena) {
      value = ::google::protobuf::internal::GetOwnedMessage(message_arena, value, submessage_arena);
    }
    _impl_._has_bits_[0] |= 0x00000004u;
